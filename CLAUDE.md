...
- **`Dockerfile` and `.github/workflows/static.yml` are template-managed** and get overwritten on template upgrade. Fix them upstream in UserRepo/CentralRepo, not here.
